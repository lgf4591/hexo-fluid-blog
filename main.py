...
clashmeta_without_warp = curl('https://mareep.netlify.app/sub/merged_proxies_new.yaml')
clashmeta_with_warp = curl('https://mareep.netlify.app/sub/merged_warp_proxies_new.yaml')
shadowrocket_and_nekoray = curl('https://mareep.netlify.app/sub/shadowrocket_base64.txt')
sing_box = curl('https://mareep.netlify.app/sub/sb.json')
