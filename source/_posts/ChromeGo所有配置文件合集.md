...
> Last Update Time: 2024-02-07 00:59:55
---
...
dns:
  ...
  fallback:
    ...
    - tls://dns.google:853
proxies:
  - {"name":"dongtaiwang.com_1","type":"tuic","server":"74.63.249.229","port":443,"udp":true,"uuid":"9a6140f4-abd8-4ece-aa0e-4f14556de56b","password":dongtaiwang.com,"alpn":["h3"],"disable-sni":true,"reduce-rtt":true,"udp-relay-mode":native,"congestion-controller":"bbr"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
...
dns:
  ...
  fallback:
    ...
    - tls://dns.google:853
proxies:
  - {"name":"dongtaiwang.com_1","type":"tuic","server":"108.181.2.158","port":33440,"udp":true,"uuid":"996c2970-ec1c-4659-9c5f-b3609c42a764","password":dongtaiwang.com,"alpn":["h3"],"disable-sni":true,"reduce-rtt":true,"udp-relay-mode":native,"congestion-controller":"bbr"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
