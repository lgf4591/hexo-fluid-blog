...
> Last Update Time: 2024-02-08 15:48:41
---
...
dns:
  ...
  fallback:
    ...
    - tls://dns.google:853
proxies:
  - {"name":"dongtaiwang.com_1","type":"vless","server":"23.227.38.54","port":2096,"uuid":"e80e0204-ddf1-4f59-8e75-44ea502aabae","tls":true,"servername":"2.dtku43.xyz","network":"ws","ws-opts":{"path":"/mjyrws","headers":{"host":"2.dtku43.xyz"}},"client-fingerprint":"chrome"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
...
dns:
  ...
  fallback:
    ...
    - tls://dns.google:853
proxies:
  - {"name":"dongtaiwang.com_1","type":"tuic","server":"109.104.152.161","port":44550,"udp":true,"uuid":"0c008b79-86e6-403d-b684-8ba559562c9e","password":dongtaiwang.com,"alpn":["h3"],"disable-sni":true,"reduce-rtt":true,"udp-relay-mode":native,"congestion-controller":"bbr"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
...
dns:
  ...
  fallback:
    ...
    - tls://dns.google:853
proxies:
  - {"name":"dongtaiwang.com_1","type":"vless","server":"cloudflare.cfgo.cc","port":2053,"uuid":"627016c6-a565-47f9-93cf-df937b38bbb7","tls":true,"servername":"4.dtku43.xyz","network":"ws","ws-opts":{"path":"/hcxiws","headers":{"host":"4.dtku43.xyz"}},"client-fingerprint":"chrome"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
...
dns:
  ...
  fallback:
    ...
    - tls://dns.google:853
proxies:
  - {"name":"dongtaiwang.com_1","type":"tuic","server":"64.31.55.124","port":44556,"udp":true,"uuid":"a72c47f7-5d2d-4029-a5ca-997ac2d1c956","password":dongtaiwang.com,"alpn":["h3"],"disable-sni":true,"reduce-rtt":true,"udp-relay-mode":native,"congestion-controller":"bbr"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
